...
return [
    ...
    'payment' => [
        ...
        //notch pay
        'notchpay_description' => 'Accept payments on your store using Notch Pay.',
        'notchpay_enabled' => 'Notch Pay is available for your store.',
        'notchpay_disabled' => 'Notch Pay is not enabled.',
        'notchpay_provider' => 'This provider allows you to integrate Notch Pay PHP into your store to allow your customers to make payments.',
        'notchpay_about' => 'Learn more about Notch Pay',
        'notchpay_actions' => 'Enabled Notch Pay',
        'notchpay_environment' => 'Notch Pay has two environments Sandbox and Live, make sure to use sandbox for testing before going live.',
        'notchpay_dashboard' => 'API Keys can be grabbed from',
    ],
    ...
    'notifications' => [
        ...
        'notchpay' => 'Your Notch Pay configuration have been correctly updated!',
        'stripe_enable' => 'You have successfully enabled Stripe payment for your store!',
        'notchpay_enable' => 'You have successfully enabled Stripe payment for your store!',
    ],
