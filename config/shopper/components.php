...
use App\Http\Livewire\Settings\Payments\General;
use App\Http\Livewire\Settings\Payments\NotchPay;
...
return [
    ...
    */
    ...
    'livewire' => [
        ...
        'dashboard' => Livewire\Orders\Browse::class,
        ...
        'settings.payments.general' => General::class,
        'settings.payments.stripe' => Livewire\Settings\Payments\Stripe::class,
        'settings.payments.notch-pay' => NotchPay::class,
